...
> tested** (`app/`, 149/149 end‑to‑end), running on the **real migrated data** (2,825 items · 414 fleet
...
| **Alerts** | dashboard exception board: reorder / below‑minimum · lubricant days‑of‑cover · battery warranty due/expired · overdue job cards · pending pricing |
...
npm run smoke                # 149/149 end-to-end
...
│   └── README.md
├── sql/schema.sql       # the validated 77-table PostgreSQL schema the app runs on
