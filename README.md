...
> tested** (`app/`, 115/115 end‑to‑end), running on the **real migrated data** (2,825 items · 414 fleet
...
npm run smoke                # 115/115 end-to-end
...
│   └── README.md
├── sql/schema.sql       # the validated 75-table PostgreSQL schema the app runs on
