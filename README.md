...
> tested** (`app/`, 134/134 end‑to‑end), running on the **real migrated data** (2,825 items · 414 fleet
...
npm run smoke                # 134/134 end-to-end
...
│   └── README.md
├── sql/schema.sql       # the validated 76-table PostgreSQL schema the app runs on
